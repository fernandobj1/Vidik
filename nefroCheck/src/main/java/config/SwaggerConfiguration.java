...
public class SwaggerConfiguration extends WebMvcConfigurationSupport{
		...
		public Docket publicMethods(){
			return new Docket(DocumentationType.SWAGGER_2)
					.groupName("Aqui")
					.select()
					.apis(RequestHandlerSelectors.basePackage("com.fbj.checklist.controller"))
...
//		}
		private ApiInfo metaData(){
				return new ApiInfoBuilder().title("Api FBJ").description("\"REST API suporte\"").version("1.0.0")
						.build();
		}
		@Override
